...
describe('Solo precompile tests', function () {
    ...
    it('Claiming have no effect on erc side', async () => {
        ...
        // .wait() required: getTransactionCount(pending) on the next
        // write can hit a different RPC pod via the LB and reuse this
        // tx's nonce, orphaning one of them.
    ...
    it('Claim (all) has no effect on erc assets', async () => {
        ...
        // .wait() required — LB nonce race; see [solo #4].
