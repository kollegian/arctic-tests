...
describe('ERC721 Tests', function () {
    ...
    describe('Write ops for erc721 tests', function () {
        ...
        it.skip('Alice will see the failed tx event on sei_getBlocksByNumber', async () => {
        ...
        it.skip('Alice will see the failed tx event on sei_getBlocksByHash', async () => {
    ...
    describe('Read ops for erc721 tests', function (){
        ...
        it.skip('Alice can see the nft mint event with sei_getLogs', async () => {
            const logParams = {
                fromBlock: ethers.toQuantity(mintTxReceipt.blockNumber - 2),
                toBlock: ethers.toQuantity(mintTxReceipt.blockNumber + 3),
                address: erc721Contract.getAddress() as string,
        ...
        it.skip('Alice can see the nft mint event with sei_getBlocksByNumber', async () => {
        ...
        it.skip('Alice can see the nft mint event with sei_getBlocksByHash', async () => {
        ...
        it.skip('Alice can see the nft transfer event with sei_getLogs', async () => {
            const logParams = {
                fromBlock: ethers.toQuantity(transferTxReceipt.blockNumber - 2),
                toBlock: ethers.toQuantity(transferTxReceipt.blockNumber + 3),
                address: erc721Contract.getAddress() as string,
        ...
        it.skip('Alice can see the nft transfer event with sei_getBlocksByNumber', async () => {
        ...
        it.skip('Alice can see the nft transfer event with sei_getBlocksByHash', async () => {
        ...
        it.skip('Alice can see nft approve event with sei_getLogs', async () => {
            const logParams = {
                fromBlock: ethers.toQuantity(approvalTxReceipt.blockNumber - 2),
                toBlock: ethers.toQuantity(approvalTxReceipt.blockNumber + 2),
                address: erc721Contract.getAddress() as string,
        ...
        it.skip('Alice can see nft approve event with sei_getBlocksByNumber', async () => {
        ...
        it.skip('Bobs transfer will appear correctly on sei_getLogs', async () => {
            const logParams = {
                fromBlock: ethers.toQuantity(transferTxReceipt.blockNumber - 2),
                toBlock: ethers.toQuantity(transferTxReceipt.blockNumber + 2),
                address: erc721Contract.getAddress() as string,
        ...
        it.skip('Given that there are multiple txs in the same block Alice can see the nft transfer event with sei_getLogs', async () => {
            const logParams = {
                fromBlock: ethers.toQuantity(transferTxReceipt.blockNumber - 2),
                toBlock: ethers.toQuantity(transferTxReceipt.blockNumber + 3),
                address: erc721Contract.getAddress() as string,
        ...
        it.skip('Given that there are multiple txs in the same block Alice can see the nft transfer event with sei_getBlocksByNumber', async () => {
            const block = await rpcClient.sei_getBlockByNumber(ethers.toQuantity(transferTxReceipt.blockNumber), true);
            expect(block.transactions.length).to.be.gte(1, 'Expected multiple transactions in the block');
        });
        ...
        it.skip('Given that there are multiple txs in the same block Alice can see the nft transfer event with sei_getBlocksByHash', async () => {
            const block = await rpcClient.sei_getBlockByHash(transferTxReceipt.blockHash, true);
            expect(block.transactions.length).to.be.gte(1, 'Expected multiple transactions in the block');
        });
