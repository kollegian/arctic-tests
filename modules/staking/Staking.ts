...
import {execCommandAndReturnJson} from '../tokenfactory/helpers';
...
export default class Staking {
  ...
  async delegateTx(seiUser: SeiUser, validatorAddress: string, amount: Coin){
    const msg = {
      ...
      value: Encoder.cosmos.staking.v1beta1.MsgDelegate.fromPartial({
        delegator_address: seiUser.seiAddress,
  ...
  async sendRawTransaction(validatorAddress: string) {
    ...
    const account = await Querier.cosmos.auth.v1beta1.Account({
  ...
  async undelegateTx(user: SeiUser, validatorAddress: string, amount: Coin){
    const msg = {
      typeUrl: `/${Encoder.cosmos.staking.v1beta1.MsgUndelegate.$type}`,
      value: Encoder.cosmos.staking.v1beta1.MsgUndelegate.fromPartial({
  ...
  async redelegateTx(sender: SeiUser, validatorDstAddress: string, amount: Coin, validatorSrcAddress: string){
    const msg = {
      typeUrl: `/${Encoder.cosmos.staking.v1beta1.MsgBeginRedelegate.$type}`,
      value: Encoder.cosmos.staking.v1beta1.MsgBeginRedelegate.fromPartial({
        delegator_address: this.signerAddress,
  ...
  async queryDelegations(validatorAddress: string){
    return Querier.cosmos.staking.v1beta1.Delegation({
  ...
  async queryValidators(status: string = 'BOND_STATUS_BONDED') {
    return Querier.cosmos.staking.v1beta1.Validators(
      {
        status,
      },
      {
  ...
  async queryValidator(validatorAddress: string) {
    return Querier.cosmos.staking.v1beta1.Validator(
      {
        validator_addr: validatorAddress,
      },
      {
  ...
  async queryDelegatorDelegations() {
    return Querier.cosmos.staking.v1beta1.DelegatorDelegations(
      {
        delegator_addr: this.signerAddress,
      },
      {
  ...
  async queryDelegatorUnbondingDelegations() {
    return Querier.cosmos.staking.v1beta1.DelegatorUnbondingDelegations(
      {
        delegator_addr: this.signerAddress,
      },
      {
  ...
  async queryRedelegations(srcValidatorAddr: string, dstValidatorAddr: string) {
    return Querier.cosmos.staking.v1beta1.Redelegations(
      {
        delegator_addr: this.signerAddress,
  ...
  async queryValidatorDelegations(validatorAddress: string) {
    return Querier.cosmos.staking.v1beta1.ValidatorDelegations(
      {
        validator_addr: validatorAddress,
      },
      {
  ...
  async queryValidatorUnbondingDelegations(validatorAddress: string) {
    return Querier.cosmos.staking.v1beta1.ValidatorUnbondingDelegations(
      {
        validator_addr: validatorAddress,
      },
      {
  ...
  async queryUnbondingDelegation(validatorAddr: string) {
    return Querier.cosmos.staking.v1beta1.UnbondingDelegation(
      {
        delegator_addr: this.signerAddress,
        validator_addr: validatorAddr,
      },
  ...
  async queryDelegatorValidators() {
    return Querier.cosmos.staking.v1beta1.DelegatorValidators(
      {
        delegator_addr: this.signerAddress,
      },
      {
  ...
  async queryDelegatorValidator(validatorAddr: string) {
    return Querier.cosmos.staking.v1beta1.DelegatorValidator(
      {
        delegator_addr: this.signerAddress,
        validator_addr: validatorAddr,
      },
  ...
  async queryPool() {
    return Querier.cosmos.staking.v1beta1.Pool({}, {pathPrefix: this.restEndpoint});
  }

  async queryParameters() {
    return Querier.cosmos.staking.v1beta1.Params({}, {pathPrefix: this.restEndpoint});
  }

  async queryHistoricalInfo(height: number) {
    return Querier.cosmos.staking.v1beta1.HistoricalInfo(
      {
        height,
      },
      {
  ...
  async cmdUnbondingDelegations(delegatorAddress: string) {
    ...
    return unbondingDelegations.unbonding_delegation_responses;
  }
